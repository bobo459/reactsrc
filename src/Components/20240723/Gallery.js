...
export function Gallery() {
  ...
  return (
    <>
      <Container>
        <h2>
          <Title>{sculptureList[count].name}</Title>
          by {sculptureList[count].artist}
        </h2>
        <h4>
          {count} of {sculptureList.length}
          <button onClick={Prev} style={{ marginLeft: "20px" }}>Prev</button>
          <button onClick={Next} style={{ marginLeft: "20px" }}>Next</button>
        </h4>
        <Box>
          <Img>
